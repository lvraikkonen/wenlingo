...
- Modify: `apps/api/tests/test_llm_contracts.py` (remaining wrapper contract tests)

- [x] **Step 1: Update wrapper tests to use a fake runner**
...
- [x] **Step 2: Run wrapper test and verify failure**
...
- [x] **Step 3: Update wrapper signatures**
...
- [x] **Step 4: Keep legacy result type compatibility**
...
- [x] **Step 5: Update remaining wrapper tests**
...
- [x] **Step 6: Run wrapper and runner tests**
...
Implementation note, 2026-06-17: use `ProductEvent("ai_daily_limit_reached")`
as the Admin `daily_limit_hit_count` source of truth. Do not also increment
`daily_limit_hit_count` from `LLMCallLog.final_status == "daily_limit_reached"`,
because the runner records the log and the route records the product event for
