...
- [ ] **Step 1: Write runner tests for primary success and fallback success**
...
- [ ] **Step 2: Add runner tests for schema failure and deterministic fallback**
...
- [ ] **Step 3: Add runner tests for daily limit**
...
- [ ] **Step 5: Implement `ai_runner.py` dataclasses and helpers**
...
- [ ] **Step 6: Implement attempt execution**
...
- [ ] **Step 7: Implement logging helper and `run_ai_task()`**
