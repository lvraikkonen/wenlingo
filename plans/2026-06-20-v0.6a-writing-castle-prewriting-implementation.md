...
- [ ] **Step 3: Implement `WritingCastleModeShell`**
...
- [ ] **Step 4: Implement step components**
...
- [ ] **Step 5: Implement `ClassroomPrewritingWizard` orchestration**
...
- [ ] **Step 6: Integrate shell and wizard into essay page while preserving direct path**
...
- [ ] **Step 7: Update old essay page test to select direct mode**
